...
function foundation_widgets_init() {
    ...
    register_sidebar( array(
        'id'            => 'footer_widget_zone_left',
        'name'          => __( 'Footer widget left' ),
        'description'   => __( 'This widget zone is located on the left-hand side of footer.' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h5 class="widget__title">',
        'after_title'   => '</h5>',
    ...
    register_sidebar( array(
        'id'            => 'footer_widget_zone_center',
        'name'          => __( 'Footer widget center' ),
        'description'   => __( 'This widget zone is located on the center side of footer.' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h5 class="widget__title">',
        'after_title'   => '</h5>',
    ...
    register_sidebar( array(
        'id'            => 'footer_widget_zone_right',
        'name'          => __( 'Footer widget right' ),
        'description'   => __( 'This widget zone is located on the right-hand side of footer.' ),
        'before_widget' => '<aside id="%1$s" class="widget %2$s">',
        'after_widget'  => '</aside>',
        'before_title'  => '<h5 class="widget__title">',
        'after_title'   => '</h5>',
